...
DeployDatabase "C:\AzureDevOpsWorkspaces\Applications\Integration\Agdf_ReferentialData\BuildUtils\database_deploy.ps1"
DeployDatabase "C:\AzureDevOpsWorkspaces\Applications\Integration\Agdf_SecurityAudit\BuildUtils\database_deploy.ps1"
DeployDatabase "C:\AzureDevOpsWorkspaces\Applications\Integration\Agdf_SwaggerUI\BuildUtils\database_deploy.ps1"
