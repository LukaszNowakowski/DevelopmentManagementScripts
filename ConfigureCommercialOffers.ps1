...
CreateWebApplication Leonardo_Integration Agdf.Api.CommercialOffers C:\AzureDevOpsWorkspaces\Applications\Agdf\CommercialOffers_Integration\Agdf.Api.CommercialOffers axa